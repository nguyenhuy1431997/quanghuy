...
<?php echo $__env->make('page.slider', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<div class="row">
			<div class="col-md-12">			
				<div class="section-heading-title">
					...
					<p><a href="<?php echo asset('/'); ?>"><strong>Trung Tâm Gia Sư Đà Nẵng</strong></a> là trung tâm gia sư uy tín, lâu đời nhất tại Đà Nẵng. Trung tâm tuyển chọn gia sư giỏi từ các trường Đại học, Phổ thông nổi tiếng tại Đà Nẵng.<br>Gia sư dạy kèm: các môn học lớp 1 đến lớp 12, ngoại ngữ, tin học, năng khiếu, chuyên ngành... </p>
				</div>
			</div>
		</div>
					...
					<div class="media">
						...
						<div class="media-body">
							...
							<p>Phụ huynh, Học viên cần tìm gia sư giỏi, nhấp vào 
								<a href="<?php echo asset('post/create'); ?>/">[Đăng bài tìm gia sư]</a>.</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="media">
						...
						<div class="media-body">
							...
							<p>Sinh viên, Giáo viên đăng ký làm gia sư, nhấp vào 
								<a href="<?php echo asset('tutor/create'); ?>">[Đăng ký làm gia sư]</a>.</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="media">
						...
						<div class="media-body">
							...
							<p>Gia sư chọn các suất dạy phù hợp, nhấp vào 
								<a href="<?php echo asset('post'); ?>">[Các suất dạy mới]</a>.</p>
						</div>
					</div>
				</div>
			</div>			
